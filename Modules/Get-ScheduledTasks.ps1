$tasks = & schtasks.exe /query /v  /FO CSV | ConvertFrom-CSV

$tasks = $tasks | Select-Object @{name="ComputerName";expression={$env:COMPUTERNAME}}, TaskName,Author,LogonMode,"Run As User","Task to Run","Start In"
$tasks

<#
    ComputerName     : LAB-SCRIPT-01
    Name             : \Run_Compliance
    Id               : Author
    UserId           : S-1-5-18
    GroupId          : 
    ...
    Arguments        : -executionPolicy RemoteSigned -f "\\lab-script-01\Scripts\alpha\ActiveDefense_alpha.ps1"
    WorkingDirectory : 
    ClassId          : 
#>
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdZ56tcqnHL8NTDueq32B+dQc
# jomgggShMIIEnTCCBESgAwIBAgITYQAAAAedH0A3IMLoeQAAAAAABzAKBggqhkjO
...
# ARUwIwYJKoZIhvcNAQkEMRYEFMPxKfIY1z66oFswqBUv40rts+NKMA0GCSqGSIb3
# DQEBAQUABIIBAAa1l4otZObEgymiH63k4xw1C4aymDOq12oUCxirlqeuQUUJpzL2
# B1Pvb90fE+Jc43OSqA4Iy+kAu9ZMfAV0C7h+86G2lEQ8ICsJmJ2GuNJpG4hn0OBY
# w43Xo8D0s0xmuOEXT1zOq3IlAh8eProRVPHB++9uioZaJhVVnHXAZrNTC+24Ahmw
# o9amxy0JnASYtzQ0Ox9MBoX0t4GQ5fzgtDzn9VTg71lUhm1kEbSHx+6Mty6IHhUT
# K8JK5TwoksSSxxl0MEBVD32tHUlQC36l1yB1iRmD9c91RZc7r/dAcG2jvhY2L/af
# uji5nYVN4hdlf7Qum5mFFY6HH4GSIXZKAA0=
